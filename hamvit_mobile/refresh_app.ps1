...
Get-Process | Where-Object { $_.ProcessName -match 'flutter|dart' } | Stop-Process -Force -ErrorAction SilentlyContinue

adb -s emulator-5554 shell pm clear com.hamvit.mobile
adb -s emulator-5554 shell am force-stop com.hamvit.mobile
