    ...
    return ListView(
      ...
      children: [
        ...
        HamvitEditGoalButton(
          ...
          onPressed: () => context.go('/profile/body-data'),
        ...
        HamvitEditGoalButton(
          ...
          onPressed: () => context.go('/activities/preferences'),
          icon: Icons.directions_run,
        ),
        const SizedBox(height: 8),
        HamvitEditGoalButton(
          label: 'Editar sono',
          onPressed: () => context.go('/sleep/settings'),
          icon: Icons.nightlight_round,
        ),
        const SizedBox(height: 8),
        HamvitEditGoalButton(
          label: 'Editar hidratação',
          onPressed: () => context.go('/hydration/settings'),
